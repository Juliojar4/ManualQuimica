...
<section class="testemunhos-block py-10 lg:py-20 px-6 bg-gradient-to-br from-gray-50 to-gray-100" style="background-color: {{ $backgroundColor }}; color: {{ $textColor }};" id="{{ $blockId }}">
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="section-header !mb-0 lg:mb-16" data-aos="fade-up">
            <div class="flex items-center justify-center flex-col mb-4">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-blue-600 md:ml-4" style="color: {{ $textColor }};">
                        ...
                        <div class="testimonial-card mx-3 lg:mx-0">
                            ...
                            <div class="testimonial-content">
                                ...
                                <div class="testimonial-author">
                                    ...
                                    @else
                                        <div class="author-initials" style="background: linear-gradient(135deg, {{ $accentColor }}, {{ $accentColor }}CC);">
