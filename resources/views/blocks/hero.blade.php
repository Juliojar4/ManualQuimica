  ...
  <div class="container mx-auto relative z-10">
    <div class="flex flex-col items-center justify-center h-full text-center">
      ...
      {{-- Conteúdo de texto --}}
        ...
        <div>
            <h1 class="w-fit md:w-[710px] max-w-full text-center font-bold mb-6 leading-tight drop-shadow-lg min-h-[120px] flex items-center justify-center">
            <span id="animated-title" data-title="{{ esc_attr(strip_tags($title)) }}" class="inline-block"></span>
            </h1>
            <p data-aos="fade-in"   class="!text-[1.25rem] md:text-2xl mb-8 !text-green-700 leading-relaxed font-sans max-w-2xl mx-auto drop-shadow-md">
            ...
            <div data-aos="fade-in"   class="mt-8">
                <a href="{{ $buttonUrl ?? '#conteudo' }}" class="relative inline-flex items-center gap-3 bg-gradient-to-r from-teal-500 to-cyan-600 hover:from-teal-600 hover:to-cyan-700 text-gray-800 font-semibold py-2.5 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 ease-out group overflow-hidden">
                    ...
                    <div class="relative z-10 flex items-center gap-3">
                        <span class="!text-white  ">{{ $buttonText ?? 'Começar a Aprender' }}</span>
                    </div>
                </a>
            </div>
            @endif
