    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="space-y-6">
        ...
        <div class="flex space-x-4">
          <a href="#" class="w-10 h-10 bg-slate-700 hover:bg-teal-600 rounded-lg flex items-center justify-center transition-all duration-500 hover:scale-110 hover:-translate-y-1 hover:shadow-lg group">
            <svg class="w-5 h-5 text-gray-300 group-hover:text-white group-hover:rotate-12 transition-all duration-500" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="space-y-6">
        ...
        <ul class="space-y-3">
          <li><a href="/" class="text-gray-300 hover:text-blue-600 transition-all duration-500 flex items-center group hover:translate-x-1">
          ...
          <li><a href="/materiais" class="text-gray-300 hover:text-blue-600 transition-all duration-500 flex items-center group hover:translate-x-1">
            ...
            <li>
              <a href="/minha-conta" class="text-gray-300 hover:text-blue-600 transition-all duration-500 flex items-center group hover:translate-x-1">
                <svg class="w-4 h-4 mr-2 group-hover:scale-110 transition-transform duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="space-y-6">
        ...
        <form class="space-y-3">
          ...
          <button type="submit" class="w-full bg-gradient-to-r from-teal-500 to-cyan-600 hover:from-teal-600 hover:to-cyan-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 hover:scale-105 transform">
            Inscrever-se
          </button>
        </form>
